...
cred = credentials.Certificate("tec-park-firebase-adminsdk-jj8bb-e27e403039.json")

app = firebase_admin.initialize_app(cred, name="object_detect")
...
while True:
    ...
    for index, row in px.iterrows():
        ...
        if "car" in c:
            ...
            results3 = cv2.pointPolygonTest(
                np.array(area3, np.int32), ((cx, cy)), False
            )
            if results3 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list3.append(c)
            results4 = cv2.pointPolygonTest(
                np.array(area4, np.int32), ((cx, cy)), False
            )
            if results4 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list4.append(c)
            results5 = cv2.pointPolygonTest(
                np.array(area5, np.int32), ((cx, cy)), False
            )
            if results5 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list5.append(c)
            results6 = cv2.pointPolygonTest(
                np.array(area6, np.int32), ((cx, cy)), False
            )
            if results6 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list6.append(c)
            results7 = cv2.pointPolygonTest(
                np.array(area7, np.int32), ((cx, cy)), False
            )
            if results7 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list7.append(c)
            results8 = cv2.pointPolygonTest(
                np.array(area8, np.int32), ((cx, cy)), False
            )
            if results8 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list8.append(c)
            results9 = cv2.pointPolygonTest(
                np.array(area9, np.int32), ((cx, cy)), False
            )
            if results9 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list9.append(c)
            results10 = cv2.pointPolygonTest(
                np.array(area10, np.int32), ((cx, cy)), False
            )
            if results10 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list10.append(c)
            results11 = cv2.pointPolygonTest(
                np.array(area11, np.int32), ((cx, cy)), False
            )
            if results11 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
                list11.append(c)
            results12 = cv2.pointPolygonTest(
                np.array(area12, np.int32), ((cx, cy)), False
            )
            if results12 >= 0:
                cv2.rectangle(frame, (x1, y1), (x2, y2), (0, 255, 0), 2)
                cv2.circle(frame, (cx, cy), 3, (0, 0, 255), -1)
    ...
    space = 12 - o
    print(space)
    db.collection("parking_spaces").document("space_info").update(
        {
            "C1parking": space,
        }
    )
    if a1 == 1:
        ...
        cv2.putText(
            frame, str("1"), (50, 441), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a2 == 1:
        ...
        cv2.putText(
            frame, str("2"), (106, 440), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a3 == 1:
        ...
        cv2.putText(
            frame, str("3"), (175, 436), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a4 == 1:
        ...
        cv2.putText(
            frame, str("4"), (250, 436), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a5 == 1:
        ...
        cv2.putText(
            frame, str("5"), (315, 429), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a6 == 1:
        ...
        cv2.putText(
            frame, str("6"), (386, 421), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a7 == 1:
        ...
        cv2.putText(
            frame, str("7"), (456, 414), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a8 == 1:
        ...
        cv2.putText(
            frame, str("8"), (527, 406), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a9 == 1:
        ...
        cv2.putText(
            frame, str("9"), (591, 398), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a10 == 1:
        ...
        cv2.putText(
            frame, str("10"), (649, 384), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a11 == 1:
        ...
        cv2.putText(
            frame, str("11"), (697, 377), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    if a12 == 1:
        ...
        cv2.putText(
            frame, str("12"), (752, 371), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 0, 255), 1
        )
    else:
    ...
    cv2.putText(
        frame, str(space), (23, 30), cv2.FONT_HERSHEY_PLAIN, 3, (255, 255, 255), 2
    )
